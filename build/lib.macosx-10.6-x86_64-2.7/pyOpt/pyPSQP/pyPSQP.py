	...
	def __init__(self, pll_type=None, *args, **kwargs):
		...
		**Keyword arguments:**
		...
		13 : 'Maximum number of gradient evaluations exceeded',
                -11: 'Maximum number of iterations exceeded?  Possibly some other bad things, too',
                -10: 'Maximum number of iterations exceeded?  Possibly some other bad things, too',
